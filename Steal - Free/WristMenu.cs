...
namespace Steal
{
    [BepInPlugin("com.steal.lol", "stealFREE", "1.0.0")]
    public class StealFree : BaseUnityPlugin
    {
        public void LateUpdate()
        {
            if (!GameObject.Find("stealfree"))
            {
                GameObject ms = new GameObject("stealfree");
                ms.AddComponent<StealFree>();
    ...
    class MenuPatch : MonoBehaviour
    {
        ...
        public static Button[] buttons =
        {
            ...
            new Button("Rope Up", Category.Movement, true, false, ()=>RopeUp()),
            new Button("Rope Down", Category.Movement, true, false, ()=>RopeDown()),
            new Button("Rope To Self", Category.Movement, true, false, ()=>RopeToSelf()),
            new Button("Rope Gun", Category.Movement, true, false, ()=>RopeGun(), ()=>CleanUp()),
            
            new Button("Rope Fling", Category.Movement, true, false, ()=>FlingOnRope()),
            new Button("Rope Freeze", Category.Movement, true, false, ()=>RopeFreeze()),
            ...
            new Button("Un Acid Self", Category.Special, false, false, ()=>UnAcidSelf(), null, true),
