    ...
    internal class ShowConsole : MonoBehaviour
    {
        ...
        public void Logo()
        {
            ...
            try
            {
                ...
                {
                    Log("Steal.lol Version: [FREE]" + Version.MajorVersion + "." + Version.MinorVersion + "." + Version.Revision + " Update Available: TRUE");
                    return;
                }
                Log("Steal.lol Version: [FREE]" + Version.MajorVersion + "." + Version.MinorVersion + "." + Version.Revision + " Update Available: FALSE");
