...
public class ModsList : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        guiStyle.normal.textColor = Main.GetTheme(SettingsLib.Settings.BackgroundColor)[2];
        guiStyle.fontSize = 20;
        guiStyle.wordWrap = true;

        guiStyle2 = new GUIStyle();
        guiStyle2.font = Resources.GetBuiltinResource<Font>("Arial.ttf");
        guiStyle2.normal.textColor = Main.GetTheme(SettingsLib.Settings.BackgroundColor)[2];
    ...
    void OnGUI()
    {
        ...
        for (int i = 0; i < displayedText2.Length; i++)
        {
            ...
            guiStyle2.normal.textColor = (i == highlightedIndex) ? Main.GetTheme(SettingsLib.Settings.BackgroundColor)[2]*1.6f : Main.GetTheme(SettingsLib.Settings.BackgroundColor)[2];
